 ...
 * @since 1.4.0
 */
@EeExtensionDef(name = "fluentd", group = EeExtensionGroup.LOGS)
@EeComponentDependencies({
        @EeComponentDependency(EeComponentType.SERVLET)
})
public class FluentdLogExtension implements LogsExtension {
    ...
    public void init(KumuluzServerWrapper kumuluzServerWrapper, EeConfig eeConfig) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> LoggersQueue.getInstance().closeLoggerConnections()));
