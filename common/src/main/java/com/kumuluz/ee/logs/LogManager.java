...
public class LogManager {
     ...
     *
     * @param loggerName String logger name
     * @return LogLevel representing the level of the underlying implementation
     */
     ...
     *
     * @param loggerName String logger name
     * @param logLevel   LogLevel representing the level of the underlying implementation
     */
