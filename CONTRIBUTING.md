# Contributing to KumuluzEE Logs

♥ [KumuluzEE Logs](https://github.com/kumuluz/kumuluzee-logs) and want to get involved?
...
**[File a bug report](https://github.com/kumuluz/kumuluzee-logs/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-logs.git
   # Navigate to the newly cloned directory
   cd kumuluzee-logs
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kumuluz/kumuluzee-logs.git
   ```
